...
/**
 * Proxy que controla o acesso ao RemoteAudioStream.
 */
public class ProtectedAudioStreamProxy implements AudioStream {
  ...
  /**
   * Construtor completo do proxy.
   *
   * @param track faixa de áudio.
   * @param plan plano do usuário.
   * @param loader fábrica do stream real.
   */
  ...
  /**
   * Construtor de conveniência do proxy.
   *
   * @param track faixa de áudio.
   * @param plan plano do usuário.
   */
